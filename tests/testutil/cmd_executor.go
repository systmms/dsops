...
import (
	...
	"github.com/systmms/dsops/pkg/exec"
)

// Re-export the interface and real executor from pkg/exec for backward compatibility.
// This allows existing code to continue importing from testutil while we migrate.
